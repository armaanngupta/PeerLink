   ...
   private static class Multiparser {
      ...
      public ParseResult parse() {
         try {
            ...
            byte[] boundaryBytes = ("\r\n--" + boundary + "--").getBytes();
            int contentEnd = findSequence(data, boundaryBytes, contentStart); // to find the end of content, can also use indexOf() as were using earlier
            if (contentEnd == -1) {
               boundaryBytes = ("\r\n--" + boundary).getBytes();
      ...
      public static class ParseResult {       //pojo, my own data type
